"""
Django settings for vacci_track_backend project.
...
SECRET_KEY = "django-insecure-qd-@ghcner%ou#gwo((yd*p(xi8y8c3u3&9f$pmtj4x+#k21$e"
...
INSTALLED_APPS = [
    ...
    "vacci_track_backend_app.apps.VacciTrackBackendAppConfig",
    "rest_framework",
...
ROOT_URLCONF = "vacci_track_backend.urls"
...
WSGI_APPLICATION = "vacci_track_backend.wsgi.application"
